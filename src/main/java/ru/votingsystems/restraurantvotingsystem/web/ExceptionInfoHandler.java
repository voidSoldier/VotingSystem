...
import ru.votingsystems.restraurantvotingsystem.util.exception.ApplicationException;
import ru.votingsystems.restraurantvotingsystem.util.exception.ErrorInfo;
import ru.votingsystems.restraurantvotingsystem.util.exception.ErrorType;
import ru.votingsystems.restraurantvotingsystem.util.exception.IllegalRequestDataException;

import javax.servlet.http.HttpServletRequest;
import java.util.Map;

import static ru.votingsystems.restraurantvotingsystem.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public ExceptionInfoHandler(MessageSourceAccessor messageSourceAccessor) {
        ExceptionInfoHandler.messageSourceAccessor = messageSourceAccessor;
    }
